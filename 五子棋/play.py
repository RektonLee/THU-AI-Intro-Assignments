...
def get_player(player_name, args):
    if player_name == "DummyPlayer":
        ...
        return MCTSPlayer(args.c, args.n_sample)
    elif player_name == "AlphaZeroPlayer":
        return AlphaZeroPlayer(get_evaluation_func(args.evaluation_func), args.c, args.n_sample)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--player_1", type=str, default="Human", help="Agent of Player 1")
    parser.add_argument("--player_2", type=str, default="Human", help="Agent of Player 2")
    ...
    parser.add_argument("--n_sample", type=int, default=5000, help="Number of playouts (MCTS/AlphaZero only).")
